...
HD_PWD='C:/Users/Admin/Dropbox/PC/Documents/FPGA_proj/Vivado/LFSR_2022_2/LFSR_2022_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lfsr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_lfsr.tcl -notrace
