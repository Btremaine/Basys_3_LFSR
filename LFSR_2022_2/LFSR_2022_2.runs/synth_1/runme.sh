...
HD_PWD='C:/Users/Admin/Dropbox/PC/Documents/FPGA_proj/Vivado/LFSR_2022_2/LFSR_2022_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lfsr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lfsr.tcl
